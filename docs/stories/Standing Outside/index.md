...
Then the two drawings, where the approach stops being a detail and becomes the entire subject. In *The Pilgrimage to Know Where* the cathedral is one building among several around a square, the mountains still visible behind it, and the pilgrim standing in the open with the option of going anywhere. In *The Pilgrimage to Know Where Too* the town has closed in, the street is narrow, and every line in the drawing runs to the cathedral door at the end of it. He has no choices left. That is what a nave does to a person, done to a street. There is one more if you want it, a black spire at the left edge of *The Last Holiday* with a magpie flying over it, which is as much church as that painting needed.

So: a kerk, an Orthodox church, a Dutch parish church, a Friday mosque and two cathedrals, and not one interior among them. I do not think that is squeamishness. These buildings are machines for drawing people towards a door. The tower announces the position, the dome does it from further out, the avenue and the path and the narrow street do the pulling once you are close, and all of it is designed and it all works. I have stood in front of them and felt it work. What I have painted, every time, is the last place you can stand and still be outside, and then I have set up there and stayed.
