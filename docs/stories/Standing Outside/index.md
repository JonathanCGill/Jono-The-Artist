...
<div class="image-label">The Passage</div>

![The Passage - watercolour of a colonnaded passage hung with climbing plants, insects on the walls and a small structure at the end of the aisle](The%20Passage.jpg){ .story-img loading=lazy }
...
Six of these have gone up on the wall over the years, in four countries and for three different religions, and I have never once painted the inside of any of them. That is not a policy. I only noticed it when I put them next to each other, and then it stopped looking like an accident.
...
Then the two drawings, where the approach stops being a detail and becomes the entire subject. In *The Pilgrimage to Know Where* the cathedral is one building among several around a square, the mountains still visible behind it, and the pilgrim standing in the open with the option of going anywhere. In *The Pilgrimage to Know Where Too* the town has closed in, the street is narrow, and every line in the drawing runs to the cathedral door at the end of it. He has no choices left. That is what a nave does to a person, done to a street. There is a seventh if you want it, and it is the only one I cannot put a name to. A black spire at the left edge of *The Last Holiday*, standing over the Grote Die in Amsterdam Noord with a magpie flying across it. The maps give the water a name and leave the church without one. That is as much church as that painting needed, and it is still the outside of the building.

So: a kerk, an Orthodox church, two Dutch parish churches, a Friday mosque and two cathedrals, and not one interior among them. I do not think that is squeamishness. These buildings are machines for drawing people towards a door. The tower announces the position, the dome does it from further out, the avenue and the path and the narrow street do the pulling once you are close, and all of it is designed and it all works. I have stood in front of them and felt it work. What I have painted, every time, is the last place you can stand and still be outside, and then I have set up there and stayed.

The joke is that I have painted an interior of exactly that shape, and it is not a church at all. *The Passage* is a colonnade in one point perspective, plants climbing the columns, roundels on the walls where the windows would be, an aisle of floorboards running away from you, and a small structure at the end of it that everything in the picture is arranged around. It is full of insects. Spiders on the floor, a snail, dragonflies and butterflies mounted in the roundels, a bee hotel on the axis where the altar goes. Given six chances to walk through a door and paint what was on the other side, I went and built my own, and the congregation is invertebrate.
